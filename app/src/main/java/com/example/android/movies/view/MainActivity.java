...
import com.example.android.movies.adapter.ImageAdapter;
import com.example.android.movies.model.Movies;
import com.example.android.movies.model.MoviesLoader;
import com.example.android.movies.model.Result;
...
public class MainActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener, LoaderManager.LoaderCallbacks<Movies>
{
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.settings:
                Intent i = new Intent(this, com.example.android.movies.view.SettingsActivity.class);
                startActivity(i);
                return true;
